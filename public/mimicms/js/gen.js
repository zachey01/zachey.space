...
document.querySelector("form").addEventListener("submit", function (event) {
  ...
  if (option == "yes") {
    ...
    <ol>
    <li>Register a free account on <a href="https://replit.com/login" style="color: white">Replit</a>.</li>
    <li><p style="display: inline-flex">And click to: <img src="/img/install/create-repl.png" alt="Create a repl" width="150" style="margin-left: 10px"></p></li>
    <li><img src="/img/install/create-repl-menu.png" alt="Create a repl" width="500" style="margin-left: 10px"></li>
    <li>And unpack files from downloaded archive.</li>
    <li>Link domain: <img src="/img/install/repl-linking-domain.png" alt="Linking domain" width="500" style="margin-left: 10px"></li>
  </ol> 
  Enjoy! 😊
    `;
  } else {
      ...
      .then((data) => {
        ...
        function addFileToZip(url) {
          let fileName = url.substring(
            url.lastIndexOf("/mimicms/mimicms/") + 1
          );
          return fetch("mimicms/mimicms/" + url)
